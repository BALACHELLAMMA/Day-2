...
function findLargestElementInArray(array,largestPosition){
    if(typeof largestPosition!=='number' && !largestPosition <=0) return 'enter valid position'
...
console.log(findLargestElementInArray(array, 4));
console.log(findLargestElementInArray(array, -1));
